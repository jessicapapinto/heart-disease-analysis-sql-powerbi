...
Hyperlipidaemia and diabetes are well-established etiological risk factors for cardiovascular disease *(DOI: 10.1016/j.rec.2020.10.006)*. Reference values for total cholesterol:

- **< 200 mg/dl:** desirable
- **200-239 mg/dl:** borderline high
- **>= 240 mg/dl:** high risk
- **Fasting blood sugar > 120 mg/dl (fbs = 1):** indicates possible diabetes or pre-diabetes
...
The dataset contains **920 patients** and **14 clinical variables** collected from four institutions: Cleveland Clinic Foundation, Hungarian Institute of Cardiology, University Hospital Zurich, and VA Long Beach.

| Variable | Description | Clinical Reference Values |
|----------|-------------|--------------------------|
| age | Patient age in years | Risk increases after 45 (M) / 55 (F) |
| sex | Male / Female | Males at higher risk at younger age |
| cp | Chest pain type | typical angina / atypical angina / non-anginal / asymptomatic |
| trestbps | Resting blood pressure (mmHg) | Normal < 120 mmHg |
| chol | Serum cholesterol (mg/dl) | Normal < 200, High > 240 |
| fbs | Fasting blood sugar > 120 mg/dl | 1 = possible diabetes |
| restecg | Resting ECG results | normal / lv hypertrophy / st-t abnormality |
| thalch | Maximum heart rate achieved | Decreases with age |
| exang | Exercise-induced angina | 1 = present (concerning) |
| oldpeak | ST depression induced by exercise | > 2 mm clinically significant |
| slope | Slope of peak exercise ST segment | upsloping / flat / downsloping |
| ca | Major vessels colored (0-3) | 0 = healthy, 3 = severe disease |
| thal | Stress test result | normal / fixed defect / reversable defect |
| num | Heart disease severity (0-4) | 0 = no disease, 1-4 = disease present |

> **Important:** The variable `num` represents disease severity from 0 (no disease) to 4 (severe disease). For binary analysis, values 1-4 are grouped as *disease present*. This is consistent with standard practice in cardiovascular research.

---

## 4. Analysis Objectives

This analysis aims to answer the following clinical questions:

1. Does sex influence the likelihood of heart disease?
2. Is age a significant risk factor and does it interact with sex?
3. Are cholesterol levels associated with heart disease?
4. Which chest pain type is most predictive of heart disease?
5. Is ST segment depression (oldpeak) associated with disease?
6. How does the number of affected vessels relate to diagnosis?
7. What is the distribution of stress test results across diagnoses?
